...
import com.example.bharatbuzz.databinding.FragmentSportsBinding;
...
public class SportsFragment extends Fragment implements HomeFragment.SearchableFragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        binding.swipeRefreshLayout.setOnRefreshListener(this::fetchSportsNews);
    ...
    private void setUpAdapters() {
        ...
        binding.viewPagerTopNews.setAdapter(topAdapter);
        ...
        binding.rvNews.setAdapter(latestAdapter);
    }

    private void fetchSportsNews() {
        ApiClient.getApiInterface().getCategoryNews("us", "sports", 1, 50, API_KEY)
        ...
        autoSwipeRunnable = new Runnable() {
            ...
            public void run() {
                if (binding != null && topNewsList.size() > 0) {
                    int currentItem = binding.viewPagerTopNews.getCurrentItem();
                    int nextItem = (currentItem + 1) % topNewsList.size();
                    binding.viewPagerTopNews.setCurrentItem(nextItem, true);
    ...
    public void onSearchQuery(String query) {
        if (query == null || query.isEmpty()) {
            ...
            binding.txtCategoryHeader.setVisibility(View.VISIBLE);
            binding.viewPagerTopNews.setVisibility(View.VISIBLE);
        } else {
            binding.txtCategoryHeader.setVisibility(View.GONE);
            binding.viewPagerTopNews.setVisibility(View.GONE);
