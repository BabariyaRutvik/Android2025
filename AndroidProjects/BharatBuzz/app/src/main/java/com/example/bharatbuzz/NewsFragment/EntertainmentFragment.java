...
import com.example.bharatbuzz.databinding.FragmentEntertainmentBinding;
...
public class EntertainmentFragment extends Fragment implements HomeFragment.SearchableFragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        binding.swipeRefreshLayout.setOnRefreshListener(this::fetchEntertainmentNews);
    ...
    private void setupAdapters() {
        ...
        binding.viewPagerTopEntertainmentNews.setAdapter(topAdapter);

        latestAdapter = new NewsAdapter(requireContext(), latestNewsList);
        binding.rvEntertainmentNews.setLayoutManager(new LinearLayoutManager(requireContext()));
        binding.rvEntertainmentNews.setAdapter(latestAdapter);
    }

    private void fetchEntertainmentNews() {
        ApiClient.getApiInterface().getCategoryNews("us", "entertainment", 1, 50, API_KEY)
        ...
        autoSwipeRunnable = new Runnable() {
            ...
            public void run() {
                if (binding != null && topNewsList.size() > 0) {
                    int currentItem = binding.viewPagerTopEntertainmentNews.getCurrentItem();
                    int nextItem = (currentItem + 1) % topNewsList.size();
                    binding.viewPagerTopEntertainmentNews.setCurrentItem(nextItem, true);
    ...
    public void onSearchQuery(String query) {
        if (query == null || query.isEmpty()) {
            ...
            binding.textTopEntertainmentHeadlines.setVisibility(View.VISIBLE);
            binding.viewPagerTopEntertainmentNews.setVisibility(View.VISIBLE);
        } else {
            binding.textTopEntertainmentHeadlines.setVisibility(View.GONE);
            binding.viewPagerTopEntertainmentNews.setVisibility(View.GONE);
